...
$(document).ready(function() {
	$("#data").load('modul/lap_stok/tampil_data.php');
	...
	$("#cetak").click(function() {
		var kode1	= $("#kode1").val();
		var kode2	= $("#kode2").val();
		window.location.href='modul/laporan/lap_stok_barang.php?kode1='+kode1+'&kode2='+kode2;
		/*
	   	$.ajax({
			type	: "GET",
...
<?php
echo "<div id='form' align='center'><h2>LAPORAN AKHIR STOK BARANG <h3></div>";
